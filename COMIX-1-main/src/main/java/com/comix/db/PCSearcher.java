...
public interface PCSearcher {
    /**
     * Searches the personal collection by title
     *
     ...
     */
    List<Comic> searchByTitle(Connection conn, String param, String username) throws SQLException;

    /**
     * Searches the personal collection by series
     *
     * @param conn An SQL connection
     ...
     * @throws SQLException If there is a problem with the SQL search
     */
    List<Comic> searchBySeries(Connection conn, String param,String username) throws SQLException;

    /**
     * Searches the personal collection by issue
     *
     * @param conn An SQL connection
     ...
     * @throws SQLException If there is a problem with the SQL search
     */
    List<Comic> searchByIssue(Connection conn, String param,String username) throws SQLException;

    /**
     * Searches the personal collection by publisher
     *
     * @param conn An SQL connection
     ...
     * @throws SQLException If there is a problem with the SQL search
     */
    List<Comic> searchByPublisher(Connection conn, String param,String username) throws SQLException;

    /**
     * Searches the personal collection by release date
     *
     * @param conn An SQL connection
     ...
     * @throws SQLException If there is a problem with the SQL search
     */
    List<Comic> searchByReleaseDate(Connection conn, String param,String username) throws SQLException;

    /**
     * Searches the personal collection by creators
     *
     * @param conn An SQL connection
     ...
     * @throws SQLException If there is a problem with the SQL search
     */
    List<Comic> searchByCreators(Connection conn, String param,String username) throws SQLException;
